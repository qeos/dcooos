...
void _main(){
    ...
    printk_syslog("Video mode: ");
    printk_syslog_number(parametresHW->VBEResX, 'd');
    printk_syslog("x");
    printk_syslog_number(parametresHW->VBEResY, 'd');
    printk_syslog("x");
    printk_syslog_number(parametresHW->VBEBPP, 'd');
    printk_syslog("\n");
